        ...
        <div className="grid grid-cols-[1.5fr_1fr] w-3/5 items-center py-16 gap-64">
          <div>
            ...
            <p className="text-justify">
              ...
              Voluptates quibusdam obcaecati, ipsa numquam consequatur natus non
              quia ratione error iure quam aliquam pariatur blanditiis dolores
              mollitia velit id quae. Similique.
            </p>
          </div>
          <div>
            <Image
